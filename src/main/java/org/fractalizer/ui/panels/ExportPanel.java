...
public class ExportPanel extends ScrollPane {
    ...
    private TitledPane createMeshExportSection() {
        ...
        // Resolution slider
        meshResolutionSlider = new EnhancedSlider("Resolution", 32, 2048, 128, true);
    ...
    private void exportMesh() {
        ...
        Thread meshThread = new Thread(() -> {
            try {
                ...
                MarchingCubes.SliceProvider sliceProvider = (zIdx, zPos) -> controller.evaluateGPUSlice(zPos, boundsHalf, gridSize);
