 ...
 * Used by the CPU fallback path in Marching Cubes isosurface extraction.
 * The GPU path (evaluator.glsl) eliminates the need for this code entirely.
 */
public class FractalEvaluator {
    ...
    // ========================================================================
    // DE with orbit traps (used by CPU fallback path)
    // ========================================================================
