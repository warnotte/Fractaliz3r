/**
 * Menger Sponge Test Distance Estimator
 *
...
// ============================================================================
// Menger Sponge Test DE (full version with orbit traps)
// ============================================================================
...
float DE(vec3 pos, out OrbitTrap trap) {
    ...
    for (int i = 0; i < maxIterations + gExtraIterations; i++) {
        ...
        // Conditional center Z fold (GMT pattern)
        if (z.z < -0.5 * centerZ * (scale - 1.0)) {
            z = vec3(z.x, z.y, z.z + centerZ * (scale - 1.0));
        }

        // Manual Z shift
        z = vec3(z.x, z.y, z.z + zShift);
