 ...
 *
 * Classic IFS fractal using tetrahedral folds and uniform scaling.
 * Offset hardcoded to (1,1,1) for simplicity.
 */
...
// ============================================================================
// Sierpinski Tetrahedron DE (full version with orbit traps)
// ============================================================================
